...
if ($role === 'pengurus') {
    ...
    $jenis_kelamin = $data['jenis_kelamin_pengurus'];
    $no_hp = $data['no_hp'];
} else {
    ...
    $jenis_kelamin = $data['jenis_kelamin_warga'];
    $no_hp = $data['no_hp'];
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($role === 'pengurus') {
        ...
        $query = "UPDATE pengurus SET 
                    ...
                    jenis_kelamin_pengurus = '$jenis_kelamin_baru', 
                    no_hp = '$no_hp_baru' 
        ...
        $query = "UPDATE warga_asrama SET 
                    ...
                    jenis_kelamin_warga = '$jenis_kelamin_baru', 
                    no_hp = '$no_hp_baru' 
                  WHERE nim_warga = '$nim'";
    }
    ...
    if (mysqli_query($conn, $query)) {
        ...
        $_SESSION['jenis_kelamin'] = $jenis_kelamin_baru;
        ...
        <div class="modal-dialog modal-dialog-centered"> <!-- Modal centered -->
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <?php if ($success !== null): ?>
                        <?php if ($success): ?>
                            <i class="fas fa-check-circle fa-5x text-success mb-3"></i> <!-- Success icon -->
                            <p>Profil Anda berhasil diperbarui!</p>
                        <?php else: ?>
                            <i class="fas fa-times-circle fa-5x text-danger mb-3"></i> <!-- Error icon -->
