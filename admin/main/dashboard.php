...
?>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
     ...
     <a class="bg-white p-6 rounded-lg shadow flex items-center space-x-4 hover:bg-gray-100" href="../../home/berita/berita_admin.php">
      <i class="fas fa-newspaper text-pink-600 text-2xl">
      </i>
      <div>
       <div class="text-gray-800 font-semibold">
        Berita
