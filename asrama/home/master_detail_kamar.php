<?php
    include $_SERVER['DOCUMENT_ROOT'] . "/admin/template/head.php";
    // include $_SERVER['DOCUMENT_ROOT'] . '/asrama/connect.php';
?>
<?php
    include $_SERVER['DOCUMENT_ROOT']  . "/admin/template/sidebar.php";
?>

<?php
    include $_SERVER['DOCUMENT_ROOT']  . "/admin/template/top-bar.php";
?>
<?php 
    require "../connect.php";
    session_start();
